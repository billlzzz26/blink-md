...
**Next Step Protocol:**
If the finalized prompt requires making changes to the codebase, you MUST immediately transition to the `context-map` skill to analyze dependencies and impact before implementation.
